...
public class ViewTrainController {
    ...
    void initialize() {
        ...
        assert addBtn != null : "fx:id=\"addBtn\" was not injected: check your FXML file 'ViewTrain.fxml'.";
        ...
        assert deleteBtn != null : "fx:id=\"deleteBtn\" was not injected: check your FXML file 'ViewTrain.fxml'.";
        ...
        assert editBtn != null : "fx:id=\"editBtn\" was not injected: check your FXML file 'ViewTrain.fxml'.";
